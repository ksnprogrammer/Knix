...
export const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-knix-bg relative overflow-hidden">
       {/* Background Glows */}
       <div className="absolute top-0 left-1/4 w-96 h-96 bg-knix-red/10 rounded-full blur-[128px] pointer-events-none"></div>
       ...
       <div className="max-w-6xl mx-auto py-20 px-6 relative z-10">
          ...
          <div className="text-center mb-20 fade-in">
             <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-knix-red/10 border border-knix-red/20 text-knix-red text-xs font-bold uppercase tracking-widest mb-6">
                <Star size={12} fill="currentColor" /> Official Learning Platform
             </div>
             <h1 className="text-6xl md:text-8xl font-bold text-white font-rajdhani mb-6 tracking-tight leading-none">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400">KNIX</span> <span className="text-knix-red">EDU</span>
             </h1>
             <p className="text-xl md:text-2xl text-slate-400 max-w-3xl mx-auto mb-10 font-light leading-relaxed">
                ...
                <span className="text-white font-medium"> Combined Maths</span>.
             </p>
             <div className="flex flex-col md:flex-row justify-center gap-6">
                ...
                <button 
                  ...
                  className="bg-knix-card hover:bg-slate-800 text-white px-10 py-5 rounded-xl font-bold text-lg transition-all border border-knix-border hover:border-knix-red flex items-center justify-center gap-3"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
             {[
                ...
                <div 
                  ...
                  className={`bg-knix-card border border-knix-border p-8 rounded-2xl transition-all cursor-pointer group hover:-translate-y-2 ${sub.border}`}
                >
                   <div className={`w-12 h-12 rounded-lg ${sub.bg} flex items-center justify-center mb-6`}>
                      <Award className={sub.color} size={24} />
                   </div>
                   <h3 className="text-3xl font-bold text-white font-rajdhani mb-3">{sub.title}</h3>
                   <p className="text-slate-400 leading-relaxed">{sub.desc}</p>
             ...
             <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {[
                  ...
                  <div key={idx} className="text-center">
                    <div className="text-4xl font-bold text-white font-rajdhani mb-2">{stat.value}</div>
       ...
       {/* Footer */}
       <div className="border-t border-knix-border bg-knix-card/50 mt-20 py-10">
